 ...
 */
public class PatchAnalysisException extends Exception {
     ...
     */
    public PatchAnalysisException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @param message The detailed message.
     */
    PatchAnalysisException(String message) {
        super(message);
    }
}
