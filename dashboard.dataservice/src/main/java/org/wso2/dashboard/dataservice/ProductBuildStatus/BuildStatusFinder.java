...
public class BuildStatusFinder {
     ...
     */
    public int getProductAreaBuildStatusForDay(ProductArea productArea, long timeStamp, BuildStatusManager buildStatusManager) {
    ...
    private int getComponentBuildStatusForDay(String componentName, long timeStamp, BuildStatusManager buildStatusManager) {
        ...
        ArrayList<BuildStat> buildStats = buildStatusManager.getBuildStats(componentName, startTime, endTime);
    ...
    public int getMonthlyState(ProductArea productArea, long timestamp, BuildStatusManager buildStatusManager) {
        ...
        for (String component : components) {
            ...
            double componentScore = buildStatusManager.getComponentScore(component, startTime, timestamp);
     ...
     */
    private int getStatusCodeForScore(double score) {
    ...
    public int getWeeklyState(ProductArea productArea, long timestamp, BuildStatusManager buildStatusManager) {
        ...
        ArrayList<String> components = productArea.getComponents();
        for (String component : components) {
            double componentScore = buildStatusManager.getComponentScore(component, (timestamp - (7 * Constants.TWENTY_FOUR_HOURS)), timestamp);
            totalScore += componentScore;
        }
        return getStatusCodeForScore(totalScore / components.size());
     ...
     */
    public String getFailingComponents(ProductArea productArea, long currentTime,
