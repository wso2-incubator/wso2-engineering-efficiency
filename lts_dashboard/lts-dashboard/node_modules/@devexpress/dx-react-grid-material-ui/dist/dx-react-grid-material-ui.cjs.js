...
var List$1 = require('material-ui/List');
...
var Table$2 = require('material-ui/Table');
var dxReactCore = require('@devexpress/dx-react-core');
var List$2 = _interopDefault(require('material-ui-icons/List'));
var Toolbar$2 = _interopDefault(require('material-ui/Toolbar'));
...
var Item = function Item(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(List$1.ListItemText, { primary: column.title || column.name })
  );
};
...
var Table$4 = styles.withStyles(styles$14, { name: 'Table' })(TableBase);
...
var TableLayout$1 = function TableLayout$$1(_ref) {
  ...
  return React.createElement(dxReactGrid.TableLayout, {
    ...
    headComponent: materialUi.TableHead,
    bodyComponent: materialUi.TableBody,
...
var TableStubCellBase = function TableStubCellBase(_ref) {
  ...
  return React.createElement(materialUi.TableCell, _extends({
    style: style,
    className: classNames(classes.cell, className)
  }, restProps));
};
...
var styles$25 = function styles$$1(theme) {
  return {
    toolbar: {
      borderBottom: '1px solid ' + (theme.palette.type === 'light' ? colorManipulator.lighten(colorManipulator.fade(theme.palette.text.lightDivider, 1), 0.925) : colorManipulator.darken(colorManipulator.fade(theme.palette.text.lightDivider, 1), 0.685))
    }
  };
};
...
var Toolbar$4 = styles.withStyles(styles$25, { name: 'Toolbar' })(ToolbarBase);
