...
import { Action, DragDropProvider, DragSource, DropTarget, Getter, PluginContainer, PluginHost, Template, TemplateConnector, TemplatePlaceholder } from '@devexpress/dx-react-core';
import { TABLE_DATA_TYPE, TABLE_REORDERING_TYPE, addRow, addedRowsByIds, allSelected, cancelAddedRows, cancelChanges, cancelColumnGroupingDraft, cancelDeletedRows, cancelTableColumnWidthDraft, cellValueGetter, changeAddedRow, changeColumnFilter, changeColumnGrouping, changeColumnOrder, changeColumnSorting, changeRow, changeTableColumnWidth, changedRowsByIds, columnChooserItems, createRowChangeGetter, customGroupedRows, customGroupingRowIdGetter, deleteRows, draftColumnGrouping, draftOrder, draftTableColumnWidth, evalAnimations, expandedGroupRows, filterActiveAnimations, filteredRows, getAnimations, getAvailableToSelect, getColumnExtension, getColumnFilterConfig, getColumnSortingDirection, getGroupCellTargetIndex, getMessagesFormatter, getRowChange, getTableRowColumnsWithColSpan, getTableTargetColumnIndex, groupRowChecker, groupRowLevelKeyGetter, groupedRows, groupingPanelItems, isAddedTableRow, isDataTableCell, isDataTableRow, isDetailRowExpanded, isDetailTableRow, isDetailToggleTableCell, isEditCommandsTableCell, isEditTableCell, isEditTableRow, isFilterTableCell, isFilterTableRow, isGroupIndentTableCell, isGroupTableCell, isGroupTableRow, isHeaderStubTableCell, isHeadingEditCommandsTableCell, isHeadingTableCell, isHeadingTableRow, isNoDataTableRow, isSelectAllTableCell, isSelectTableCell, orderedColumns, pageCount, paginatedRows, rowCount, rowIdGetter, rowsWithPageHeaders, setCurrentPage, setPageSize, someSelected, sortedRows, startEditRows, stopEditRows, tableColumnsWithDataRows, tableColumnsWithDetail, tableColumnsWithEditing, tableColumnsWithGrouping, tableColumnsWithSelection, tableColumnsWithWidths, tableDataColumnsExist, tableHeaderRowsWithFilter, tableHeaderRowsWithReordering, tableRowsWithDataRows, tableRowsWithEditing, tableRowsWithExpandedDetail, tableRowsWithGrouping, tableRowsWithHeading, toggleColumn, toggleDetailRowExpanded, toggleExpandedGroups, toggleSelection, visibleTableColumns } from '@devexpress/dx-grid-core';
...
var pluginDependencies = [{ pluginName: 'TableColumnVisibility' }, { pluginName: 'Toolbar' }];
...
var createStateHelper = function createStateHelper(component) {
  ...
  var applyReducer = function applyReducer(reduce, payload, callback) {
    var stateUpdater = function stateUpdater(prevState) {
      var state = _extends({}, component.getState(prevState), component.state !== prevState ? prevState : null);
      if (initialState === null) {
        initialState = state;
      }
      var nextState = _extends({}, state, reduce(state, payload));
  ...
  createClass(FilteringState, [{
    ...
    value: function getState() {
      var _props$filters = this.props.filters,
          filters = _props$filters === undefined ? this.state.filters : _props$filters;
    ...
    value: function notifyStateChange(nextState, state) {
      var filters = nextState.filters;
      var onFiltersChange = this.props.onFiltersChange;
...
var pluginDependencies$1 = [{ pluginName: 'FilteringState' }];
...
var EditingState = function (_React$PureComponent) {
  ...
  function EditingState(props) {
    ...
    _this.commitChangedRows = function (_ref) {
      ...
      _this.props.onCommitChanges({
        changed: changedRowsByIds(_this.getState().rowChanges, rowIds)
      });
    ...
    _this.commitAddedRows = function (_ref2) {
      ...
      _this.props.onCommitChanges({
        added: addedRowsByIds(_this.getState().addedRows, rowIds)
      });
  ...
  createClass(EditingState, [{
    ...
    value: function getState() {
      var _props = this.props,
          _props$editingRowIds = _props.editingRowIds,
          editingRowIds = _props$editingRowIds === undefined ? this.state.editingRowIds : _props$editingRowIds,
          _props$rowChanges = _props.rowChanges,
          rowChanges = _props$rowChanges === undefined ? this.state.rowChanges : _props$rowChanges,
          _props$addedRows = _props.addedRows,
          addedRows = _props$addedRows === undefined ? this.state.addedRows : _props$addedRows,
          _props$deletedRowIds = _props.deletedRowIds,
          deletedRowIds = _props$deletedRowIds === undefined ? this.state.deletedRowIds : _props$deletedRowIds;
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var editingRowIds = nextState.editingRowIds;
      var onEditingRowIdsChange = this.props.onEditingRowIdsChange;

      if (onEditingRowIdsChange && editingRowIds !== state.editingRowIds) {
        onEditingRowIdsChange(editingRowIds);
      }

      var rowChanges = nextState.rowChanges;
      var onRowChangesChange = this.props.onRowChangesChange;

      if (onRowChangesChange && rowChanges !== state.rowChanges) {
        onRowChangesChange(rowChanges);
      }

      var addedRows = nextState.addedRows;
      var onAddedRowsChange = this.props.onAddedRowsChange;

      if (onAddedRowsChange && addedRows !== state.addedRows) {
        onAddedRowsChange(addedRows);
      }

      var deletedRowIds = nextState.deletedRowIds;
      var onDeletedRowIdsChange = this.props.onDeletedRowIdsChange;
    ...
    value: function render() {
      var _props2 = this.props,
          createRowChange = _props2.createRowChange,
          columnExtensions = _props2.columnExtensions;

      var _getState = this.getState(),
          editingRowIds = _getState.editingRowIds,
          rowChanges = _getState.rowChanges,
          addedRows = _getState.addedRows,
          deletedRowIds = _getState.deletedRowIds;
...
var PagingState = function (_React$PureComponent) {
  ...
  createClass(PagingState, [{
    ...
    value: function notifyStateChange(nextState, state) {
      ...
      var onCurrentPageChange = this.props.onCurrentPageChange;

      if (onCurrentPageChange && currentPage !== state.currentPage) {
        onCurrentPageChange(currentPage);
      }

      var pageSize = nextState.pageSize;
...
var pluginDependencies$2 = [{ pluginName: 'PagingState' }];
...
var currentPageComputed = function currentPageComputed(_ref4, _ref5) {
  ...
  if (totalPages - 1 < currentPage) {
    setCurrentPage$$1(adjustedCurrentPage);
  }
...
var pluginDependencies$3 = [{ pluginName: 'PagingState' }];
...
var GroupingState = function (_React$PureComponent) {
  ...
  createClass(GroupingState, [{
    ...
    value: function getState() {
      var _props = this.props,
          _props$grouping = _props.grouping,
          grouping = _props$grouping === undefined ? this.state.grouping : _props$grouping,
          _props$expandedGroups = _props.expandedGroups,
          expandedGroups = _props$expandedGroups === undefined ? this.state.expandedGroups : _props$expandedGroups;
    ...
    value: function notifyStateChange(nextState, state) {
      ...
      var expandedGroups = nextState.expandedGroups;
    ...
    value: function render() {
      var _getState2 = this.getState(),
          ...
          draftGrouping = _getState2.draftGrouping,
...
var pluginDependencies$4 = [{ pluginName: 'GroupingState' }];
...
var pluginDependencies$5 = [{ pluginName: 'GroupingState' }];
  ...
  createClass(SelectionState, [{
    ...
    value: function getState() {
      var _props$selection = this.props.selection,
          selection = _props$selection === undefined ? this.state.selection : _props$selection;
...
var pluginDependencies$6 = [{ pluginName: 'SelectionState' }];

var IntegratedSelection = function (_React$PureComponent) {
  inherits(IntegratedSelection, _React$PureComponent);

  function IntegratedSelection(props) {
    classCallCheck(this, IntegratedSelection);

    var _this = possibleConstructorReturn(this, (IntegratedSelection.__proto__ || Object.getPrototypeOf(IntegratedSelection)).call(this, props));

    _this.state = { availableToSelect: [] };

    _this.toggleSelectAll = _this.toggleSelectAll.bind(_this);
    _this.availableToSelect = _this.availableToSelect.bind(_this);
    return _this;
  }

  createClass(IntegratedSelection, [{
    key: 'toggleSelectAll',
    value: function toggleSelectAll(state, getters, _ref) {
      var toggleSelection$$1 = _ref.toggleSelection;
      var availableToSelect = this.state.availableToSelect;

      toggleSelection$$1({ rowIds: availableToSelect, state: state });
    }
  }, {
    key: 'availableToSelect',
    value: function availableToSelect(_ref2) {
      var rows = _ref2.rows,
    ...
    value: function render() {
      ...
      var allSelectedComputed = function allSelectedComputed(_ref3) {
        var selection = _ref3.selection;
        return allSelected({ selection: selection, availableToSelect: availableToSelect });
      };
      var someSelectedComputed = function someSelectedComputed(_ref4) {
        var selection = _ref4.selection;
        return someSelected({ selection: selection, availableToSelect: availableToSelect });
      };
      ...
      return React.createElement(
        ...
        React.createElement(Getter, { name: 'rows', computed: this.availableToSelect }),
        ...
        React.createElement(Getter, { name: 'selectAllAvailable', value: !!availableToSelect.length }),
        React.createElement(Action, { name: 'toggleSelectAll', action: this.toggleSelectAll })
      );
    }
  }]);
...
var SortingState = function (_React$PureComponent) {
  ...
  function SortingState(props) {
    ...
    _this.changeColumnSorting = stateHelper.applyReducer.bind(stateHelper, changeColumnSorting);
    return _this;
  }
  ...
  createClass(SortingState, [{
    ...
    value: function getState() {
      var _props$sorting = this.props.sorting,
          sorting = _props$sorting === undefined ? this.state.sorting : _props$sorting;
...
var pluginDependencies$7 = [{ pluginName: 'SortingState' }];
...
var pluginDependencies$8 = [{ pluginName: 'Table' }];
...
var pluginDependencies$9 = [{ pluginName: 'DataTypeProvider', optional: true }];
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          function (params) {
            return React.createElement(NoDataCell, _extends({ getMessage: getMessage }, params));
          }
        ),
        React.createElement(
          Template,
    ...
    value: function render() {
      ...
      return React.createElement(
        PluginContainer,
        {
          ...
          dependencies: [{ pluginName: 'Table' }, { pluginName: 'SelectionState' }, { pluginName: 'IntegratedSelection', optional: !showSelectAll }]
        },
...
var RowDetailState = function (_React$PureComponent) {
  ...
  createClass(RowDetailState, [{
    key: 'getState',
    value: function getState() {
      var _props$expandedRowIds = this.props.expandedRowIds,
          expandedRowIds = _props$expandedRowIds === undefined ? this.state.expandedRowIds : _props$expandedRowIds;
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var expandedRowIds = nextState.expandedRowIds;
      var onExpandedRowIdsChange = this.props.onExpandedRowIdsChange;
    ...
    value: function render() {
      var _getState = this.getState(),
          expandedRowIds = _getState.expandedRowIds;
...
var pluginDependencies$10 = [{ pluginName: 'Table' }];
  ...
  createClass(TableRowDetail, [{
    ...
    value: function render() {
      ...
      var tableBodyRowsComputed = function tableBodyRowsComputed(_ref2) {
        ...
        return tableRowsWithExpandedDetail(tableBodyRows, expandedRowIds, rowHeight);
      };
          ...
          function (params) {
            return React.createElement(
              ...
              function (_ref4, _ref5) {
                var expandedRowIds = _ref4.expandedRowIds;
...
var pluginDependencies$11 = [{ pluginName: 'GroupingState' }, { pluginName: 'Table' }, { pluginName: 'DataTypeProvider', optional: true }];
  ...
  createClass(TableGroupRow, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        GroupIndentCell && React.createElement(
          Template,
          {
            name: 'tableCell',
            predicate: function predicate(_ref6) {
    ...
    value: function render() {
      ...
      return React.createElement(
        PluginContainer,
        {
          ...
          dependencies: [{ pluginName: 'Table' }, { pluginName: 'SortingState', optional: !showSortingControls }, { pluginName: 'GroupingState', optional: !showGroupingControls }, { pluginName: 'DragDropProvider', optional: true }, { pluginName: 'TableColumnResizing', optional: true }]
        },
...
var pluginDependencies$12 = [{ pluginName: 'FilteringState' }, { pluginName: 'Table' }, { pluginName: 'DataTypeProvider', optional: true }];
...
var pluginDependencies$13 = [{ pluginName: 'EditingState' }, { pluginName: 'Table' }, { pluginName: 'DataTypeProvider', optional: true }];
...
var pluginDependencies$14 = [{ pluginName: 'EditingState' }, { pluginName: 'Table' }];
...
var pluginDependencies$15 = [{ pluginName: 'Table' }];
...
var TableColumnResizing = function (_React$PureComponent) {
  ...
  createClass(TableColumnResizing, [{
    key: 'getState',
    value: function getState() {
      var _props$columnWidths = this.props.columnWidths,
          columnWidths = _props$columnWidths === undefined ? this.state.columnWidths : _props$columnWidths;
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var columnWidths = nextState.columnWidths;
      var onColumnWidthsChange = this.props.onColumnWidthsChange;
...
var pluginDependencies$16 = [{ pluginName: 'PagingState' }];
    ...
    value: function render() {
        ...
        return React.createElement(
          ...
          function (_ref2, _ref3) {
            ...
            return React.createElement(Item, {
              item: item,
              showSortingControls: showSortingControls && sorting !== undefined,
              sortingDirection: sorting !== undefined ? getColumnSortingDirection(sorting, columnName) : undefined,
      ...
      return React.createElement(
        PluginContainer,
        {
          ...
          dependencies: [{ pluginName: 'GroupingState' }, { pluginName: 'Toolbar' }, { pluginName: 'SortingState', optional: !showSortingControls }]
        },
        React.createElement(
          Template,
          { name: 'toolbarContent' },
...
var pluginDependencies$17 = [{ pluginName: 'Table' }];
...
var TableColumnVisibility = function (_React$PureComponent) {
  ...
  createClass(TableColumnVisibility, [{
    key: 'getState',
    value: function getState() {
      var _props$hiddenColumnNa = this.props.hiddenColumnNames,
          hiddenColumnNames = _props$hiddenColumnNa === undefined ? this.state.hiddenColumnNames : _props$hiddenColumnNa;
    ...
    key: 'notifyStateChange',
    value: function notifyStateChange(nextState, state) {
      var hiddenColumnNames = nextState.hiddenColumnNames;
      var onHiddenColumnNamesChange = this.props.onHiddenColumnNamesChange;
    ...
    value: function render() {
      ...
      var _getState = this.getState(),
          hiddenColumnNames = _getState.hiddenColumnNames;
