  ...
  function EditingState(props) {
    ...
    _this.commitChangedRows = function (_ref) {
      ...
      _this.props.onCommitChanges({
        changed: dxGridCore.changedRowsByIds(_this.getState().rowChanges, rowIds)
      });
    ...
    _this.commitAddedRows = function (_ref2) {
      ...
      _this.props.onCommitChanges({
        added: dxGridCore.addedRowsByIds(_this.getState().addedRows, rowIds)
      });
...
var IntegratedSelection = function (_React$PureComponent) {
  ...
  createClass(IntegratedSelection, [{
    ...
    value: function availableToSelect(_ref2) {
      ...
      this.setState({ availableToSelect: dxGridCore.getAvailableToSelect(rows, getRowId, isGroupRow) });
      return rows;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var allSelectedComputed = function allSelectedComputed(_ref3) {
        ...
        return dxGridCore.allSelected({ selection: selection, availableToSelect: availableToSelect });
      };
      var someSelectedComputed = function someSelectedComputed(_ref4) {
        var selection = _ref4.selection;
        return dxGridCore.someSelected({ selection: selection, availableToSelect: availableToSelect });
      };
      ...
      return React.createElement(
        ...
        React.createElement(dxReactCore.Getter, { name: 'rows', computed: this.availableToSelect }),
        ...
        React.createElement(dxReactCore.Getter, { name: 'selectAllAvailable', value: !!availableToSelect.length }),
        React.createElement(dxReactCore.Action, { name: 'toggleSelectAll', action: this.toggleSelectAll })
      );
    }
  }]);
...
var SortingState = function (_React$PureComponent) {
  ...
  function SortingState(props) {
    ...
    _this.changeColumnSorting = stateHelper.applyReducer.bind(stateHelper, dxGridCore.changeColumnSorting);
    return _this;
  }
  ...
  createClass(TableRowDetail, [{
    ...
    value: function render() {
      ...
      var tableBodyRowsComputed = function tableBodyRowsComputed(_ref2) {
        ...
        return dxGridCore.tableRowsWithExpandedDetail(tableBodyRows, expandedRowIds, rowHeight);
      };
            ...
            return React.createElement(
              ...
              function (_ref4, _ref5) {
                ...
                return React.createElement(ToggleCell, _extends({}, params, {
                  row: params.tableRow.row,
                  expanded: dxGridCore.isDetailRowExpanded(expandedRowIds, params.tableRow.rowId),
                  onToggle: function onToggle() {
...
var TableColumnResizing = function (_React$PureComponent) {
  ...
  function TableColumnResizing(props) {
    ...
    _this.changeTableColumnWidth = stateHelper.applyReducer.bind(stateHelper, dxGridCore.changeTableColumnWidth);
    _this.draftTableColumnWidth = stateHelper.applyReducer.bind(stateHelper, dxGridCore.draftTableColumnWidth);
        ...
        return React.createElement(
          ...
          function (_ref2, _ref3) {
            ...
            return React.createElement(Item, {
              item: item,
              showSortingControls: showSortingControls && sorting !== undefined,
              sortingDirection: sorting !== undefined ? dxGridCore.getColumnSortingDirection(sorting, columnName) : undefined,
